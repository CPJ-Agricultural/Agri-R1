#!/usr/bin/env python3
"""
AGMMU Inference with COT - Generalization Experiment
...
# System prompt for COT reasoning on agricultural multiple choice questions
...
def batch_inference(model, processor, batch_data, device, max_new_tokens=512):
    """Batch inference with COT format"""
    batch_images = []
    batch_texts = []
    valid_indices = []
    ...
    for idx, item in enumerate(batch_data):
        try:
            ...
            # Build conversation with COT system prompt
            messages = [
...
def main():
    parser = argparse.ArgumentParser(description="AGMMU Inference with COT")
    ...
    print("="*80)
    print("AGMMU Generalization Inference with COT")
    print("="*80)
