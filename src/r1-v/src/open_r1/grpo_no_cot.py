# GRPO Agricultural VQA Training - No COT Version
...
def format_reward(completions, **kwargs):
    ...
    Evaluate structure integrity and content quality (no COT version)
    """
    rewards = []
...
def main(script_args, training_args, model_args):
    ...
    print("\n" + "="*80)
    print("GRPO Agricultural VQA Training - No COT Version")
    print("="*80)
