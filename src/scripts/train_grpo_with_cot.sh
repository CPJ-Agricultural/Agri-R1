#!/bin/bash
# ============================================================================
# GRPO Training with COT for Agricultural VQA
...
export WANDB_NAME="grpo_cot_200k_3epochs"
...
OUTPUT_DIR="/path/to/outputs/grpo_cot_200k_3epochs"
DS_CONFIG="${REPO_ROOT}/src/r1-v/configs/ds_zero3.json"

echo "Starting GRPO+COT training..."
