#!/bin/bash
# ============================================================================
# GRPO Training with REASONING for Agricultural VQA
...
export WANDB_NAME="grpo_reasoning_200k_3epochs"
...
OUTPUT_DIR="/path/to/outputs/grpo_reasoning_200k_3epochs"
DS_CONFIG="${REPO_ROOT}/src/r1-v/configs/ds_zero3.json"

echo "Starting GRPO+REASONING training..."
echo "Model: ${MODEL_PATH}"
echo "Dataset: ${DATASET_PATH}"
echo "Output: ${OUTPUT_DIR}"

deepspeed --num_gpus=4 "${REPO_ROOT}/src/r1-v/src/open_r1/grpo_vqa.py" \
