...
This document provides comprehensive details on the prompts and evaluation methods used in the Agri-R1 project, covering COT (Chain-of-Thought) generation, COT enhancement, and GRPO (Group Relative Policy Optimization) training.

---

## Table of Contents

1. [Stage 1: COT Data Generation](#stage-1-cot-data-generation)
2. [Stage 1.5: COT Enhancement](#stage-15-cot-enhancement)
...
4. **Question type matters**: Detection accuracy improves COT relevance
...
### COT Generation Issues

**Problem:** Generated COTs lack step structure
...
**Key Files:**
- `src/stage1_cot/generate_cot.py` - COT generation implementation
- `src/stage1_cot/enhance_cot.py` - COT enhancement implementation
